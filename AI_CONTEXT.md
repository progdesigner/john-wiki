...
## 진행 중 프로젝트
- [[lampas-harness]] — Claude Agent SDK 웹 하네스. 맥미니 launchd 데몬(웹 8787/API 3787), 외부 접속은 Tailscale Funnel. 기본 모델 claude-opus-4-8.
...
## 확정된 결정
- 원격 접속은 Tailscale Funnel — 고정 IP·포트포워딩·Cloudflare Tunnel 사용 안 함.
