...
- [[2026-09-14-모델-단계-프로브]] — `/model` 슬래시 커맨드로 세션 한정 모델을 `Opus 5`로 전환한 것뿐인 트리비얼 터미널 세션(18:02:47), 이상 정황 없음. 같은 저녁 프로브 세트의 실제 첫 사건(48초 뒤 아래 "모델 busy 프로브"로 이어짐) — "Opus 5" 표시명은 [[model-selection]]에 신규 관찰로 반영
