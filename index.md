...
- [[lampas-web-reels]] — lampas-system 스포츠 클립 파이프라인 "Reels": 클립·카피 선택→편집 그룹 생성→Package 전송. 2026-09-26 첫 정식 엔티티화(이전엔 코드체 언급만). 2026-09-19부터 페르소나 선택 데이터도 [[lampas-web-pulse]] 라이브러리에서 조회. [[lampas-web-flow]] Jev 자동화 검증 중 편집 그룹 저장 시 카피 연결 정보 누락 버그 발견·수정
