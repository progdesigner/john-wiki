...
- [[2026-07-16-봇메시지-클릭읽어주기-커밋푸시]] — "모두 commit 해줘"→"푸시 해줘" 2왕복 quick 운영 세션. 이전 병합의 충돌 마커 잔존 정리 + 봇 말풍선 클릭 읽어주기/정지 토글(세 번째 TTS 트리거, 구현방식 미상) 커밋 `4cff973`→rebase→`9e45de9` push, v0.1.36. 직전 기록 버전(0.1.30)과 5개 버전 간극 관찰
