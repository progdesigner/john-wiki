...
- **Package 연동**: 갤러리에 있는 완성 영상을 선택해 Package로 전송 (`[[lampas-web-flow]]` 6번째 노드).
...
## 관련
- 상위 파이프라인: [[lampas-agent]](영상 수집·클립) · [[lampas-web-copy]](페르소나·카피, 카드 스트립
  디자인 원본) · [[lampas-web-flow]](오케스트레이션)
- 상위 제품: [[lampas-studio]] (저장소 `lampas-system`)
- 세션: [[2026-09-20-lampas-flow-만들기]] (Jev 자동화 중 카피 연결 누락 버그 발견·수정)
