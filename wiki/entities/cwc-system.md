...
- 2026-09-26 ingest로 소급 확인: [[2026-09-11-elevino-admin모바일메뉴-소장신청차단취소]] 세션이
  이미 2026-09-11~12에 작업 폴더를 `apps/elevino-admin`으로 잡고 `admin.elevino.io`에 직접
  배포한 기록 — `apps/elevino-*`가 최소 09-11부터 elevino 프로덕션 배포 경로로 쓰이고 있었음을
  뒷받침.
