...
## 개발일지 초안 발행 경로 (2026-07-16)
`[[progdesigner]]`가 "지난주 진행한 내용 블로그로 써줘"라고만 요청 → 어시스턴트가 git 커밋 로그로
직접 초안을 작성하고 [[naver-blog-tag-seo]] 절차로 SEO 태그까지 준비한 뒤, `naver_blog_create_post`
발행 여부를 사람에게 되물으며 종료(이 트랜스크립트 안에서 실제 발행 확인은 안 됨). 태그 스킬의
"본문은 사람에게 받아야 한다" 전제가 **어시스턴트 자신이 저자인 신규 글**에는 적용되지 않는
사례 → 절차는 [[dev-log-blog-from-git-log]]. → [[2026-07-16-람파스-개발일지-블로그-seo최적화]]

## 관련
- 호스트: [[lampas-harness]] (노출 경로: [[harness-mcp-bridge]])
- 스킬: [[naver-blog-mcp-posting]] · [[naver-blog-tag-seo]] · [[dev-log-blog-from-git-log]]
- 세션: [[2026-07-13-람파스-누적운영기억-이관]] · [[2026-07-13-블로그-ai기억글-해시태그]] · [[2026-07-16-네이버데이터api-콘텐츠자동화-의사결정]] · [[2026-07-16-람파스-개발일지-블로그-seo최적화]]
