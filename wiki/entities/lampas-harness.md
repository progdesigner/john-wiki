...
순수 운영 세션("모두 commit 해줘"→"푸시 해줘")이라 구현 코드는 소스에 없고, 어시스턴트가 diff를
읽고 요약한 내용만 확인됨.

- **충돌 마커(`<<<<<<< HEAD` 등) 잔존 정리** — 이전 병합 커밋에 남아있던 conflict marker 제거.
  어느 병합이 마커를 남겼는지는 소스에 근거 없어 미상. [[rebase-local-feature-onto-refactored-remote]]
  스킬의 "마커 잔존 여부 전체 검색" 단계가 과거 한 번은 누락됐던 실증 사례로 기록.
- **봇 말풍선 클릭 시 읽어주기/정지 토글** — 이날 이미 있었던 TTS 관련 두 갈래
  ([[2026-07-16-tts-stream-elevenlabs-구현착수]] ElevenLabs·완료 미확인 / [[2026-07-16-롱프레스설정-자동음성재생-구현]]
  Web Speech API 자동재생·완료됨 v0.1.30)에 이은 **세 번째 트리거**(말풍선 클릭 = 수동 재생/정지).
  어느 백엔드(Web Speech API vs ElevenLabs)를 쓰는지는 이 세션 소스만으로 판별 불가 — 재개 시
  `apps/web/index.html` 재생 버튼 핸들러를 코드로 확인할 것.
- **버전 0.1.36** — 직전 위키 기록 버전(0.1.30, `3d16ed5`)과 사이에 최소 5개 버전 간극. 그 사이
  변경이 위키에 ingest되지 않고 지나간 것으로 보임(원인 미확정).
- 커밋 `4cff973`(로컬) → 원격에 새 커밋 있어 **rebase** → `9e45de9` push 완료.
  → 세션: [[2026-07-16-봇메시지-클릭읽어주기-커밋푸시]]
...
## 관련
- 세션: [[2026-07-06-lampas-harness-구축]] · [[2026-07-08-lampas-스튜디오-레퍼런스-instagram]] · [[2026-07-08-장기기억-provider-연동-설계]] · [[2026-07-08-스케줄러-로컬llm-사용영역페르소나]] · [[2026-07-09-일반-사용영역-페르소나-설정]] · [[2026-07-11-desktop-퀵채팅-설치-스크립트]] · [[2026-07-13-람파스-누적운영기억-이관]] · [[2026-07-14-quick-html-이미지-첨부-구현]] · [[2026-07-15-올리브유-마케팅-포지셔닝]] · [[2026-07-15-과금모드-토글-컨텍스트표시]] · [[2026-07-15-사용량한도-rate-limit-sdk-확인]] · [[2026-07-15-데스크톱-file메뉴-new-window]] · [[2026-07-15-gpt-realtime-음성입력-길게누르기]] · [[2026-07-15-보관메모리확인-하네스재시작-커밋푸시]] · [[2026-07-15-auto모델-기능-최초구현]] · [[2026-07-15-auto모델-난이도판정-확인ux-개선]] · [[2026-07-15-세션상주프로세스-백그라운드작업생존-구현]] · [[2026-07-16-음성입력-진동비프-피드백]] · [[2026-07-16-기억버튼-보관통합-NaN토큰버그수정]] · [[2026-07-16-메모리인제스트-크레딧버그-근본수정]] · [[2026-07-16-tts-stream-elevenlabs-구현착수]] · [[2026-07-16-롱프레스설정-자동음성재생-구현]] · [[2026-07-16-봇메시지-클릭읽어주기-커밋푸시]]
