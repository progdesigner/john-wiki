...
**참고**: 같은 날 11:39~12:26에도 Space 설계 세션이 있었다([[2026-07-15-웹ai-프롬프트분할-샷변경-되돌리기-space설계]],
2026-07-16 ingest로 뒤늦게 위키에 반영됨). 그 세션은 `category:'space'` 재사용안(5필드 분할)까지 설계했으나
권한 채널 장애로 구현 전 중단됐고, 이 세션은 그 설계를 참조하지 않고 처음부터 재조사했다 — 세부 전략이
달라진 경위는 [[lampas-studio]] Space 섹션의 "선행 설계와의 차이" 참고.
